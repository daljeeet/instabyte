...
const Profile = () => {
    ...
    const [inputval, setInputval] = useState(loggedInUser?.name)
        ...
        <div className='px-1 md:m-auto py-14' >
            <div className='flex h-40 items-center justify-between md:w-[50%] m-auto relative'>
                ...
                <div className='border-2 ml-4 rounded-full relative border-blue-400/60'>
                    <Image className="rounded-full w-24 h-24" src={`${loggedInUser?.image||"/demo_img.png"}`} width={100} height={100} alt="loggedInUser.name" blurDataURL={BlurImage} />
