...
const about = () => {
  return (
    <>
      <Navbar />
      <div className='md:w-1/2 sm:3/4 base-1 m-auto p-4 pb-20'>
        ...
        <p className='text-sm m-auto flex items-center w-fit mt-4'>Made with <AiFillHeart className='text-red-600 mx-2 animate-bounce repeat-infinite ' /> by <Link href={"https://github.com/daljeet-coder"} className='text-blue-400 mx-2 underline'>Daljeet</Link> & <Link href={'https://github.com/RationalPrabal'} className='text-blue-400 mx-2 underline'>Prabal</Link> </p>
      </div>
    </>
  )
}
