...
const SrchModal = (props:srchProptypes) => {
  return (
    <div onClick={props.closeSrchModal} className={`absolute md:left-48 h-full w-screen ${props.srchModal?"block":"hidden"} `} >
                    <div onClick={(e)=>{e.stopPropagation()}} className='w-52 animate-width overflow-hidden bg-black/50 flex flex-col h-full' >
