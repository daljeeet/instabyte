    ...
    return (
        ...
        {/* mobile nav  */}
                <div className='md:hidden flex flex-row items-center z-10 bg-black fixed top-0 left-0 right-0 h-14  ' >
                 <Link href={'/'}>
                <Image src="/logod.png" alt="Instabyte" width={100} height={50} className="ml-2" />
                    </Link>
                    <input type="search" placeholder='search' className='w-3/5 m-auto outline-2 bg-gray-600/80 h-8 rounded-lg pl-2 text-white outline-none' />
