...
const DeleteModal = (props: postDataAll) => {
  ...
  return (
    <>
   {id&&<div className='fixed h-screen flex justify-center items-center right-0 top-0 left-0 bg-black/60 z-10' >
            <div className='bg-darkbg/80 flex flex-col h-32 md:h-[15%] rounded-xl md:w-[40%] items-center justify-around px-5'>
